...
class LoginForm(Form):
    ...
    track = SelectField('Select Track', choices = [(0,'Buildings and Structures'), (1,'Shopping'), (2,'Historic and Protected Sites'), (3,'Monuments and Memorials'), (4,'Parks'), (5,'Pub Crawl'), (6,'Clubbing')])
